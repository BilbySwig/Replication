...
def initSim():
    ...
    relationships=np.less_equal(rands, arrPr)
...
def generationRun():
    ...
    neighbors=np.zeros(populationSize).astype(int)
    neighbors[relationships[mother]>0]=(np.less_equal(rpn[relationships[mother]>0],arrPn[relationships[mother]>0])).astype(int)
    randoms=np.zeros(populationSize).astype(int)
    randoms[relationships[mother]==0]=(np.less_equal(rpr[relationships[mother]==0],arrPr[relationships[mother]==0])).astype(int)
